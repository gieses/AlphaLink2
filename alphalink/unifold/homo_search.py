...
from alphalink.unifold.data.utils import compress_features
from alphalink.unifold.msa import parsers
from alphalink.unifold.msa import pipeline
...
flags.DEFINE_integer("n_cpu", 8, "Number of CPU cores to use.")
