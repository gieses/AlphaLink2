...
from alphalink.unifold.msa import templates, pipeline
...
def get_null_template(
    ...
    templates_all_atom_positions = np.zeros(
        (ln, alphalink.unifold.msa.templates.residue_constants.atom_type_num, 3)
    )
    templates_all_atom_masks = np.zeros((ln, alphalink.unifold.msa.templates.residue_constants.atom_type_num))
    templates_aatype = alphalink.unifold.msa.templates.residue_constants.sequence_to_onehot(
        output_templates_sequence, alphalink.unifold.msa.templates.residue_constants.HHBLITS_AA_TO_ID
    )
    template_features = {
...
def get_template(
    ...
    hhsearch_hits = alphalink.unifold.msa.pipeline.parsers.parse_hhr(hhsearch_result)
